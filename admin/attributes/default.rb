...
default['admin']['s3_bucket_path']          = '/mnt/s3'
...
default['admin']['email']['server']         = ''
default['admin']['email']['username']       = ''
default['admin']['email']['password']       = ''
default['admin']['email']['auth']           = ''
default['admin']['email']['port']           = ''
...
default['admin']['hitpath']['host']         = ''
default['admin']['hitpath']['username']     = ''
default['admin']['hitpath']['password']     = ''
default['admin']['hitpath']['dbname']       = ''
default['admin']['hitpath']['default']      = ''